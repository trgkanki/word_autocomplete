 ...
 */var w="undefined"!=typeof navigator&&navigator.userAgent.toLowerCase().indexOf("firefox")>0;function T(e,t,n){e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent&&e.attachEvent("on".concat(t),(function(){n(window.event)}))}function C(e,t){for(var n=t.slice(0,t.length-1),r=0;r<n.length;r++)n[r]=e[n[r].toLowerCase()];return n}function k(e){"string"!=typeof e&&(e="");for(var t=(e=e.replace(/\s/g,"")).split(","),n=t.lastIndexOf("");n>=0;)t[n-1]+=",",t.splice(n,1),n=t.lastIndexOf("");return t}for(var E={backspace:8,tab:9,clear:12,enter:13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,"⇪":20,",":188,".":190,"/":191,"`":192,"-":w?173:189,"=":w?61:187,";":w?59:186,"'":222,"[":219,"]":221,"\\":220},S={"⇧":16,shift:16,"⌥":18,alt:18,option:18,"⌃":17,ctrl:17,control:17,"⌘":91,cmd:91,command:91},A={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},j={16:!1,18:!1,17:!1,91:!1},N={},D=1;D<20;D++)E["f".concat(D)]=111+D;var L=[],O="all",q=[],H=function(e){return E[e.toLowerCase()]||S[e.toLowerCase()]||e.toUpperCase().charCodeAt(0)};function P(e){O=e||"all"}function R(){return O||"all"}var M=function(e){var t=e.key,n=e.scope,r=e.method,o=e.splitKey,i=void 0===o?"+":o;k(t).forEach((function(e){var t=e.split(i),o=t.length,a=t[o-1],s="*"===a?"*":H(a);if(N[s]){n||(n=R());var u=o>1?C(S,t):[];N[s]=N[s].map((function(e){return(!r||e.method===r)&&e.scope===n&&function(e,t){for(var n=e.length>=t.length?e:t,r=e.length>=t.length?t:e,o=!0,i=0;i<n.length;i++)-1===r.indexOf(n[i])&&(o=!1);return o}(e.mods,u)?{}:e}))}}))};function I(e,t,n){var r;if(t.scope===n||"all"===t.scope){for(var o in r=t.mods.length>0,j)Object.prototype.hasOwnProperty.call(j,o)&&(!j[o]&&t.mods.indexOf(+o)>-1||j[o]&&-1===t.mods.indexOf(+o))&&(r=!1);(0!==t.mods.length||j[16]||j[18]||j[17]||j[91])&&!r&&"*"!==t.shortcut||!1===t.method(e,t)&&(e.preventDefault?e.preventDefault():e.returnValue=!1,e.stopPropagation&&e.stopPropagation(),e.cancelBubble&&(e.cancelBubble=!0))}}function W(e){var t=N["*"],n=e.keyCode||e.which||e.charCode;if(F.filter.call(this,e)){if(93!==n&&224!==n||(n=91),-1===L.indexOf(n)&&229!==n&&L.push(n),["ctrlKey","altKey","shiftKey","metaKey"].forEach((function(t){var n=A[t];e[t]&&-1===L.indexOf(n)?L.push(n):!e[t]&&L.indexOf(n)>-1?L.splice(L.indexOf(n),1):"metaKey"===t&&e[t]&&3===L.length&&(e.ctrlKey||e.shiftKey||e.altKey||(L=L.slice(L.indexOf(n))))})),n in j){for(var r in j[n]=!0,S)S[r]===n&&(F[r]=!0);if(!t)return}for(var o in j)Object.prototype.hasOwnProperty.call(j,o)&&(j[o]=e[A[o]]);e.getModifierState&&(!e.altKey||e.ctrlKey)&&e.getModifierState("AltGraph")&&(-1===L.indexOf(17)&&L.push(17),-1===L.indexOf(18)&&L.push(18),j[17]=!0,j[18]=!0);var i=R();if(t)for(var a=0;a<t.length;a++)t[a].scope===i&&("keydown"===e.type&&t[a].keydown||"keyup"===e.type&&t[a].keyup)&&I(e,t[a],i);if(n in N)for(var s=0;s<N[n].length;s++)if(("keydown"===e.type&&N[n][s].keydown||"keyup"===e.type&&N[n][s].keyup)&&N[n][s].key){for(var u=N[n][s],c=u.splitKey,l=u.key.split(c),f=[],p=0;p<l.length;p++)f.push(H(l[p]));f.sort().join("")===L.sort().join("")&&I(e,u,i)}}}function F(e,t,n){L=[];var r=k(e),o=[],i="all",a=document,s=0,u=!1,c=!0,l="+";for(void 0===n&&"function"==typeof t&&(n=t),"[object Object]"===Object.prototype.toString.call(t)&&(t.scope&&(i=t.scope),t.element&&(a=t.element),t.keyup&&(u=t.keyup),void 0!==t.keydown&&(c=t.keydown),"string"==typeof t.splitKey&&(l=t.splitKey)),"string"==typeof t&&(i=t);s<r.length;s++)o=[],(e=r[s].split(l)).length>1&&(o=C(S,e)),(e="*"===(e=e[e.length-1])?"*":H(e))in N||(N[e]=[]),N[e].push({keyup:u,keydown:c,scope:i,mods:o,shortcut:r[s],method:n,key:r[s],splitKey:l});void 0!==a&&!function(e){return q.indexOf(e)>-1}(a)&&window&&(q.push(a),T(a,"keydown",(function(e){W(e)})),T(window,"focus",(function(){L=[]})),T(a,"keyup",(function(e){W(e),function(e){var t=e.keyCode||e.which||e.charCode,n=L.indexOf(t);if(n>=0&&L.splice(n,1),e.key&&"meta"===e.key.toLowerCase()&&L.splice(0,L.length),93!==t&&224!==t||(t=91),t in j)for(var r in j[t]=!1,S)S[r]===t&&(F[r]=!1)}(e)})))}var B={setScope:P,getScope:R,deleteScope:function(e,t){var n,r;for(var o in e||(e=R()),N)if(Object.prototype.hasOwnProperty.call(N,o))for(n=N[o],r=0;r<n.length;)n[r].scope===e?n.splice(r,1):r++;R()===e&&P(t||"all")},getPressedKeyCodes:function(){return L.slice(0)},isPressed:function(e){return"string"==typeof e&&(e=H(e)),-1!==L.indexOf(e)},filter:function(e){var t=e.target||e.srcElement,n=t.tagName,r=!0;return!t.isContentEditable&&("INPUT"!==n&&"TEXTAREA"!==n&&"SELECT"!==n||t.readOnly)||(r=!1),r},unbind:function(e){if(e){if(Array.isArray(e))e.forEach((function(e){e.key&&M(e)}));else if("object"==typeof e)e.key&&M(e);else if("string"==typeof e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var o=n[0],i=n[1];"function"==typeof o&&(i=o,o=""),M({key:e,scope:o,method:i,splitKey:"+"})}}else Object.keys(N).forEach((function(e){return delete N[e]}))}};for(var $ in B)Object.prototype.hasOwnProperty.call(B,$)&&(F[$]=B[$]);if("undefined"!=typeof window){var _=window.hotkeys;F.noConflict=function(e){return e&&window.hotkeys===F&&(window.hotkeys=_),F},window.hotkeys=F}var z=F;z.filter=()=>!0,window._wcInit=function(e,t){if(!window._wcInitialized){if(window._wcInitialized=!0,z(e,(function(e){e.preventDefault(),m(0)})),t&&-1!==t.indexOf("?"))for(let e=1;e<=9;e++)!function(e){z(t.replace("?",e.toString()),(function(t){t.preventDefault(),m(e-1)}))}(e);z("esc",(function(e){d().data("autocomplete")&&(e.preventDefault(),h())})),i()(document).on("input","[contenteditable]",(function(e){x(function(){var e=a();if(!e)return null;var t=i()(e),n=s(e),r=t.text(),o=u(r,n);return null==o?null:r.substring(o[0],n)}())})),i()(document).on("blur","[contenteditable]",(function(e){h()}))}}}]);
