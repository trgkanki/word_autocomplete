 ...
 */var m="undefined"!=typeof navigator&&navigator.userAgent.toLowerCase().indexOf("firefox")>0;function x(e,t,n){e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent&&e.attachEvent("on".concat(t),(function(){n(window.event)}))}function b(e,t){for(var n=t.slice(0,t.length-1),r=0;r<n.length;r++)n[r]=e[n[r].toLowerCase()];return n}function w(e){"string"!=typeof e&&(e="");for(var t=(e=e.replace(/\s/g,"")).split(","),n=t.lastIndexOf("");n>=0;)t[n-1]+=",",t.splice(n,1),n=t.lastIndexOf("");return t}for(var T={backspace:8,tab:9,clear:12,enter:13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,"⇪":20,",":188,".":190,"/":191,"`":192,"-":m?173:189,"=":m?61:187,";":m?59:186,"'":222,"[":219,"]":221,"\\":220},C={"⇧":16,shift:16,"⌥":18,alt:18,option:18,"⌃":17,ctrl:17,control:17,"⌘":91,cmd:91,command:91},k={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},E={16:!1,18:!1,17:!1,91:!1},S={},A=1;A<20;A++)T["f".concat(A)]=111+A;var j=[],N="all",D=[],L=function(e){return T[e.toLowerCase()]||C[e.toLowerCase()]||e.toUpperCase().charCodeAt(0)};function O(e){N=e||"all"}function q(){return N||"all"}var H=function(e){var t=e.key,n=e.scope,r=e.method,o=e.splitKey,i=void 0===o?"+":o;w(t).forEach((function(e){var t=e.split(i),o=t.length,a=t[o-1],s="*"===a?"*":L(a);if(S[s]){n||(n=q());var u=o>1?b(C,t):[];S[s]=S[s].map((function(e){return(!r||e.method===r)&&e.scope===n&&function(e,t){for(var n=e.length>=t.length?e:t,r=e.length>=t.length?t:e,o=!0,i=0;i<n.length;i++)-1===r.indexOf(n[i])&&(o=!1);return o}(e.mods,u)?{}:e}))}}))};function P(e,t,n){var r;if(t.scope===n||"all"===t.scope){for(var o in r=t.mods.length>0,E)Object.prototype.hasOwnProperty.call(E,o)&&(!E[o]&&t.mods.indexOf(+o)>-1||E[o]&&-1===t.mods.indexOf(+o))&&(r=!1);(0!==t.mods.length||E[16]||E[18]||E[17]||E[91])&&!r&&"*"!==t.shortcut||!1===t.method(e,t)&&(e.preventDefault?e.preventDefault():e.returnValue=!1,e.stopPropagation&&e.stopPropagation(),e.cancelBubble&&(e.cancelBubble=!0))}}function R(e){var t=S["*"],n=e.keyCode||e.which||e.charCode;if(M.filter.call(this,e)){if(93!==n&&224!==n||(n=91),-1===j.indexOf(n)&&229!==n&&j.push(n),["ctrlKey","altKey","shiftKey","metaKey"].forEach((function(t){var n=k[t];e[t]&&-1===j.indexOf(n)?j.push(n):!e[t]&&j.indexOf(n)>-1?j.splice(j.indexOf(n),1):"metaKey"===t&&e[t]&&3===j.length&&(e.ctrlKey||e.shiftKey||e.altKey||(j=j.slice(j.indexOf(n))))})),n in E){for(var r in E[n]=!0,C)C[r]===n&&(M[r]=!0);if(!t)return}for(var o in E)Object.prototype.hasOwnProperty.call(E,o)&&(E[o]=e[k[o]]);e.getModifierState&&(!e.altKey||e.ctrlKey)&&e.getModifierState("AltGraph")&&(-1===j.indexOf(17)&&j.push(17),-1===j.indexOf(18)&&j.push(18),E[17]=!0,E[18]=!0);var i=q();if(t)for(var a=0;a<t.length;a++)t[a].scope===i&&("keydown"===e.type&&t[a].keydown||"keyup"===e.type&&t[a].keyup)&&P(e,t[a],i);if(n in S)for(var s=0;s<S[n].length;s++)if(("keydown"===e.type&&S[n][s].keydown||"keyup"===e.type&&S[n][s].keyup)&&S[n][s].key){for(var u=S[n][s],l=u.splitKey,c=u.key.split(l),f=[],p=0;p<c.length;p++)f.push(L(c[p]));f.sort().join("")===j.sort().join("")&&P(e,u,i)}}}function M(e,t,n){j=[];var r=w(e),o=[],i="all",a=document,s=0,u=!1,l=!0,c="+";for(void 0===n&&"function"==typeof t&&(n=t),"[object Object]"===Object.prototype.toString.call(t)&&(t.scope&&(i=t.scope),t.element&&(a=t.element),t.keyup&&(u=t.keyup),void 0!==t.keydown&&(l=t.keydown),"string"==typeof t.splitKey&&(c=t.splitKey)),"string"==typeof t&&(i=t);s<r.length;s++)o=[],(e=r[s].split(c)).length>1&&(o=b(C,e)),(e="*"===(e=e[e.length-1])?"*":L(e))in S||(S[e]=[]),S[e].push({keyup:u,keydown:l,scope:i,mods:o,shortcut:r[s],method:n,key:r[s],splitKey:c});void 0!==a&&!function(e){return D.indexOf(e)>-1}(a)&&window&&(D.push(a),x(a,"keydown",(function(e){R(e)})),x(window,"focus",(function(){j=[]})),x(a,"keyup",(function(e){R(e),function(e){var t=e.keyCode||e.which||e.charCode,n=j.indexOf(t);if(n>=0&&j.splice(n,1),e.key&&"meta"===e.key.toLowerCase()&&j.splice(0,j.length),93!==t&&224!==t||(t=91),t in E)for(var r in E[t]=!1,C)C[r]===t&&(M[r]=!1)}(e)})))}var I={setScope:O,getScope:q,deleteScope:function(e,t){var n,r;for(var o in e||(e=q()),S)if(Object.prototype.hasOwnProperty.call(S,o))for(n=S[o],r=0;r<n.length;)n[r].scope===e?n.splice(r,1):r++;q()===e&&O(t||"all")},getPressedKeyCodes:function(){return j.slice(0)},isPressed:function(e){return"string"==typeof e&&(e=L(e)),-1!==j.indexOf(e)},filter:function(e){var t=e.target||e.srcElement,n=t.tagName,r=!0;return!t.isContentEditable&&("INPUT"!==n&&"TEXTAREA"!==n&&"SELECT"!==n||t.readOnly)||(r=!1),r},unbind:function(e){if(e){if(Array.isArray(e))e.forEach((function(e){e.key&&H(e)}));else if("object"==typeof e)e.key&&H(e);else if("string"==typeof e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];var o=n[0],i=n[1];"function"==typeof o&&(i=o,o=""),H({key:e,scope:o,method:i,splitKey:"+"})}}else Object.keys(S).forEach((function(e){return delete S[e]}))}};for(var F in I)Object.prototype.hasOwnProperty.call(I,F)&&(M[F]=I[F]);if("undefined"!=typeof window){var W=window.hotkeys;M.noConflict=function(e){return e&&window.hotkeys===M&&(window.hotkeys=W),M},window.hotkeys=M}var B=M;B.filter=()=>!0,window._wcInit=function(e,t){if(!window._wcInitialized){if(window._wcInitialized=!0,B(e,(function(e){e.preventDefault(),g(0)})),t&&-1!==t.indexOf("?"))for(let e=1;e<=9;e++)!function(e){B(t.replace("?",e.toString()),(function(t){t.preventDefault(),g(e-1)}))}(e);B("esc",(function(e){c().data("autocomplete")&&(e.preventDefault(),f())})),i()(document).on("input","[contenteditable]",(function(e){y(function(){var e=a();if(!e)return null;var t=i()(e),n=s(e),r=t.text(),o=u(r,n);return null==o?null:r.substring(o[0],n)}())})),i()(document).on("blur","[contenteditable]",(function(e){f()}))}}}]);
